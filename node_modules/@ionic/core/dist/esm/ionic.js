import { p as plt, w as win, d as doc, N as NAMESPACE, a as promiseResolve, b as bootstrapLazy } from './index-e806d1f6.js';
import './ionic-global-9d5c8ee3.js';
import { g as globalScripts } from './app-globals-af880846.js';

/*
 Stencil Client Patch Browser v2.1.2 | MIT Licensed | https://stenciljs.com
 */
...
const patchBrowser = () => {
    ...
    }
    {
        ...
        if ( !win.customElements) {
            ...
            // @ts-ignore
            return import(/* webpackChunkName: "polyfills-dom" */ './dom-885d3ae7.js').then(() => opts);
        }
    }
